...
export default function FinanceSupportTickets() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-50" edges={['top']}>
            ...
            <View className="bg-white px-6 py-4 flex-row items-center border-b border-gray-100">
                ...
                <Text className="text-xl font-black text-gray-900">Payment Support</Text>
            </View>
                ...
                {tickets.length > 0 ? (
                    ...
                    <View className="items-center justify-center py-20">
                        ...
                        <Text className="text-gray-400 font-medium text-center mt-1 px-10">
                            No payment-related support tickets at the moment.
                        </Text>
                    </View>
                )}
                <View className="h-20" />
                    ...
                    <View className="bg-white rounded-t-[40px] p-8 max-h-[90%]">
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <TouchableOpacity
                                ...
                                className={`h-16 rounded-[28px] items-center justify-center shadow-xl shadow-emerald-500/30 ${responding || !response.trim() ? 'bg-gray-300' : 'bg-emerald-600'}`}
                            >
                                {responding ? (
